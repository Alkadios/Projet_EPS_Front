...
export default {
  ...
  setApsaSelectAnneeByApsaAndEtablissmenetAndAnnee(state: ApsaSelectAnneeState, payload: ApsaSelectAnnee[]) {
    state.apsaSelectAnneeByApsaAndEtablissmenetAndAnnee = payload;
  },
};
